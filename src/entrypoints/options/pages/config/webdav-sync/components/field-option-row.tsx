/**
 * One selectable side ("local" / "remote") of a conflicting field in the WebDAV
 * conflict tree. Mirrors the Google Drive `field-option-row.tsx` — same styles,
 * only the i18n keys point at the WebDAV namespace.
 */
...
export const STYLE_MAP = {
  local: {
    ...
    label: "options.config.sync.webdav.unresolved.localLatest",
  },
  remote: {
    ...
    label: "options.config.sync.webdav.unresolved.remoteLatest",
  },
  unresolved: {
